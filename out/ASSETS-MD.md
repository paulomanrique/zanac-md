...
| 70-71 | idol_totem | nametable (sprite unknown) | BG 4x4 to 8x8 tiles | PAL3 | 16 | — | Nametable-locked. Destroy → type 72 orb. Type 71 smiling totem / type 70 plain. Port currently uses lg_circle as placeholder sprite. |
...
| 73-79 | base_segment | 8 (probe, sat_col=0x00) + nametable | BG tiles; optional overlay | PAL3 | 16 | unknown overlay | Nametable-locked base. HP from base_segment_table. Type 75 fires type-38 pairs. Probe: pat 8 transparent — visual is tiles, not the SAT. |
