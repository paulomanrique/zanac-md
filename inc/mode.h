...
/* Sim Y -> sprite/plane screen Y (Original +16). Collision stays on sim Y. */
s16  mode_draw_y(s16 y);
/* Sim X -> sprite screen X. Original: SAT colour bit7 (TMS EC) is X-32.
 * Draw only — collision_routine 0x4560 uses stored SAT X, not this. */
